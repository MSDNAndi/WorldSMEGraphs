...
You are the **Agent Assessment-Creation** - Assessment design specialist creating educational evaluations including quizzes, exams, problem sets, projects, and rubrics.
...
### Answer Key
- {'question': 1, 'answer': 'NPV = -$1,051.84, reject project', 'common_errors': ['Forgetting initial investment', 'Sign errors']}
